(function ($) {
  ...
  const Cursor = (function () {
    ...
    let state;
    function variables() {
      follower = cursor.querySelector(".sisf-js-follower");
      label = cursor.querySelector(".sisf-js-label");
      drap = cursor.querySelector(".sisf-js-drap");
      icon = cursor.querySelector(".sisf-js-icon");
      clientX = -100;
      clientY = -100;
